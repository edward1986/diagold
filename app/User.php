...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'allowance', 'sss_deduction', 'philhealth_deduction', 'pagibig_deduction', 'sss_loan', 'pagibig_loan', 'salary', 'name', 'email', 'password', 'job_id', 'id_number', 'time_in', 'time_out', 'address', 'incase_of_emergency', 'date_started', 'sss_number', 'philhealth_number', 'pagibig_number',
    ];
