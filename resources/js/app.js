                ...
                children: [
                    ...
                    },
                    {
                        ...
                        meta: {
                            ...
                            breadcrumb:
                                [
                                    {name: 'view-attendances', label: 'View Attendance'},
                                    {name: 'create-attendances', label: 'Add Attendance'}
                                ]
                        },
                        component: resolve => require(["./components/attendance/create.vue"], resolve),
                    },
                    {
                        path: 'edit/:id',
                        ...
                        meta: {
                            ...
                            breadcrumb:
                                [
                                    {name: 'view-attendances', label: 'View Attendance'},
                                    {name: 'edit-attendances', label: 'Edit Attendance'}
                                ]},
                        component: resolve => require(["./components/attendance/create.vue"], resolve),
                    }
                ]
