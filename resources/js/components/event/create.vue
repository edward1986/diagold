                ...
                <el-card shadow="never">
                    ...
                    <el-form ref="form" @submit.native.prevent="onSubmit" :model="form">
                        ...
                        <el-form-item prop="start_date" label="Start Date">
                            <el-date-picker style="width: 100%;" value-format="yyyy-MM-dd HH:mm:ss" v-model="form.start_date" type="datetime" placeholder="Pick a day"></el-date-picker>
                        ...
                        <el-form-item prop="end_date" label="End Date">
                            <el-date-picker style="width: 100%;" value-format="yyyy-MM-dd HH:mm:ss" v-model="form.end_date" type="datetime" placeholder="Pick a day"></el-date-picker>
            ...
            onSubmit() {
                ...
                this.$refs.form.validate((valid) => {
                    if (valid) {
                        ...
                        axios[id ? 'post' : 'post'](`/api/events${id ? `/edit/${id}` : ''}`, vm.form).then(function () {
                            vm.disabled = false
                            vm.errors = {}
