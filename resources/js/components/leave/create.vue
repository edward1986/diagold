                ...
                <el-card shadow="never">
                    ...
                    <el-form ref="form" @submit.native.prevent="onSubmit" :model="form">
                        ...
                        <el-form-item prop="date_issued" label="Date Issued">
                            <el-date-picker style="width: 100%;" value-format="yyyy-MM-dd HH:mm:ss" v-model="form.date_issued" type="datetime" placeholder="Pick a day"></el-date-picker>
                        ...
                        <el-form-item prop="date_due_for_return" label="Date due for return">
                            <el-date-picker style="width: 100%;" value-format="yyyy-MM-dd HH:mm:ss" v-model="form.date_due_for_return" type="datetime" placeholder="Pick a day"></el-date-picker>
            ...
            onSubmit() {
                ...
                this.$refs.form.validate((valid) => {
                    if (valid) {
                        ...
                        axios[id ? 'post' : 'post'](`/api/holidays${id ? `/edit/${id}` : ''}`, vm.form).then(function () {
                            vm.disabled = false
                            vm.errors = {}
