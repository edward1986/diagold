<template>
    ...
    <el-form ref="form" @submit.native.prevent="onSubmit" label-position="labelPosition" size="small" :model="form">
        ...
        <el-form-item :class="errors.id_number ? 'is-error is-required' : ''" label="ID Number">
            ...
            <el-input min="0" type="number" required v-model="form.id_number"></el-input>
        ...
        <el-input min="0" type="number" required v-model="form.sss_deduction"></el-input>
        ...
        <el-input min="0" type="number" required v-model="form.philhealth_deduction"></el-input>
        ...
        <el-input min="0" type="number" required v-model="form.pagibig_deduction"></el-input>
        ...
        <el-input min="0" type="number" required v-model="form.sss_loan"></el-input>
        ...
        <el-input min="0" type="number" required v-model="form.pagibig_loan"></el-input>
        <div v-if="errors.pagibig_loan" v-for="error in errors.pagibig_loan" class="el-form-item__error">
            {{error}}
        </div>
    </el-form-item>
        <el-form-item :class="errors.allowance ? 'is-error is-required' : ''" label="DE MINIMIS">
            <el-input  min="0" type="number" required v-model="form.allowance"></el-input>
            <div v-if="errors.allowance" v-for="error in errors.allowance" class="el-form-item__error">
                {{error}}
            </div>
        </el-form-item>
