...
Route::middleware('auth:api')->group(function () {
    ...
    Route::post('/holidays/edit/{holiday}', 'HolidayController@update');
    Route::post('/events/{event}', 'EventController@destroy');
    Route::post('/events/edit/{event}', 'EventController@update');
    Route::post('/uploads/{upload}', 'UploadController@destroy');
    Route::post('/attendances/edit/{attendance}', 'AttendanceController@edit');
    Route::post('/attendances/create', 'AttendanceController@create');
    Route::get('/attendances/{attendance}', 'AttendanceController@show');
    Route::post('/attendances/{attendance}', 'AttendanceController@destroy');
    Route::apiResources([
